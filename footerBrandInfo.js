                ...
                switch (offerId) {
                        ...
                        case '32':
                         t = '<footer>'+
                                ...
                                '<img src="'+ a +'" alt="Logo" style="width:60%; max-width:150px; margin-top: 20px;"></div>'+
                                '<div class="footer terms">'+
                                '<p style="text-align: justify; padding: 20px">Todos os direitos reservados. Todo conteúdo do site, logotipos, marcas, layout, aqui veiculados são de propriedade exclusiva. É vedada qualquer reprodução, total ou parcial, de qualquer elemento de identidade, sem expressa autorização. A violação de qualquer direito mencionado implicará na responsabilização cível e criminal nos termos da Lei. 1. Produto exclusivo para servidores públicos do Rio Grande do Norte '+
