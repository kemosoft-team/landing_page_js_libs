...
// Encontre o elemento da classe "option-radio"
var optionRadio = document.querySelector('.option-radio');

// Encontre o elemento <label> dentro do elemento da classe "option-radio"
...
function isBirthValid(dateString) {
  ...
  // Verifica se a pessoa tem menos de 77 anos
  const currentDate = new Date();
  const maxBirthYear = currentDate.getFullYear();
  
  if ((maxBirthYear - yearInt) > 76) {
      return false; // A pessoa tem mais de 77 anos
    }
...
function validateForm() {
    ...
    //CPF Válido    
        ...
        showToast("O número do Whatsapp informado não é váido!");
        return false;
