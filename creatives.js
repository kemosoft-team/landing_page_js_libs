...
.then(function (response) {
    ...
    response.data.creatives.forEach(element => {
        ...
        const tr = '<tr class="brz-table__tr"><th class="brz-table__th brz-table__aside"><div class="brz-table__th--btn">'+
            ...
            '<a class="brz-a" href="https:criativos.kemobuilder.site/" data-brz-link-type="external"><span class="brz-icon brz-span brz-css-hcefj brz-css-wjkal"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 24 24" xml:'+
