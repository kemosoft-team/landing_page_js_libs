...
.then(function (response) {
    ...
    creatives.forEach(element => {
        ...
        const tr = '<tr class="brz-table__tr"><th class="brz-table__th brz-table__aside"><div class="brz-table__th--btn"><img width="8%" src="'+element.url+'">'+
            ...
            '<a class="brz-a" href="'+element.url+'" target="_blank" rel="noopener" data-brz-link-type="upload"><span class="brz-icon brz-span brz-css-vrblo brz-css-bxiof"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 24 24" xml:space="preserve" class="brz-icon-svg align-[initial]" data-type="glyph" data-name="hit-down"><g class="nc-icon-wrapper" fill="currentColor"><path data-color="color-2" fill="currentColor" d="M24,23c0,0.552-0.448,1-1,1H1c-0.552,0-1-0.448-1-1c0-0.552,0.448-1,1-1h22 C23.552,22,24,22.448,24,23z"></path> <path fill="currentColor" d="M5,9l7,9l7-9h-6V1c0-0.553-0.447-1-1-1c-0.553,0-1,0.447-1,1v8H5z"></path></g></svg></span></a><span class="brz-icon brz-span brz-css-hcefj brz-css-wjkal"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 24 24" xml:'+
