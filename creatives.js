...
.then(function (response) {
    ...
    creatives.forEach(element => {
        ...
        const tr = '<tr class="brz-table__tr"><th class="brz-table__th brz-table__aside"><div class="brz-table__th--btn"><img height="20%" src="'+element.url+'">'+
            ...
            if(document.getElementById("title")){ document.getElementById("title").innerHTML = '<h2>Criativos '+response.data.title+'</h2>';}
