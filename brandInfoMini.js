...
.then(function (response) {
    ...
    const img = '<div style="display: flex;justify-content: center; align-items: center;"><img style="width:100%; max-width:200px;" src="' + res.brandLogo + '" alt="Logomarca ' + res.brandName + '"></div>'
