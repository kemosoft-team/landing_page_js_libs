...
function validatorQuestions() {
    ...
    } else if ((firstChoice !== "não, nunca trabalhei com carteira assinada." && estiloComputado.display === 'none') || (secondChoice === "sim, já está ativado." && estiloComputado.display === 'none')) {
