...
let generalStepUrl = 'https://peach15985913.kemobuilder.site/';
...
function getTokenStatus(){
  ...
  axios.post('https://api.consigmais.com.br/lp/main/v2/getTokenData', {}, {
    headers: {
...
async function getByZipCodeInfo(zipcode){
  ...
  axios.post(baseUrl+'/getZipcodeInfo', {
    zipcode: zipcode,
  },
  {
    headers: {
...
async function registerCustomer(name, birth, federalId, phone, email){
  ...
  async function registerCustomerAddress(zipcode, address, addressNumber, state, district, city) {
    ...
    axios.post(baseUrl+'/registerCustomerInfos', {
      zipcode: zipcode,
      address: address, 
