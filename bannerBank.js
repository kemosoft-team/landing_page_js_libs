...
const contentHeader = '<div style="display: flex; justifyContent: space-between;" ><div><img class="brz-img" style="width:45%" src="https://lp-js-libs.s3.sa-east-1.amazonaws.com/assets/bmg_correspondente.png" alt="" draggable="false" loading="lazy"/></div><div></div><div style="min-width: fit-content; margin: auto;"><span class="brz-icon brz-span brz-css-ifcxp brz-css-hxdfk inline-block">'+
